...
export const esES: Dict = {
  ...
  'settings.welcomeTitle': 'Configura FBR-Design Studio',
  ...
  'settings.agentInstall.pathHint':
    'Si instalaste una CLI con npm o Homebrew y sigue apareciendo como no instalada, asegúrate de que el directorio bin de la herramienta esté en el PATH que hereda el daemon de FBR-Design Studio (Terminal y apps GUI pueden diferir en macOS). Consulta QUICKSTART.md (sección "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Abre Instalar o Docs para el agente que prefieras.',
  'settings.agentInstall.stepAuth':
    'Autentícate con la CLI del proveedor (inicia sesión o añade credenciales API) antes de volver a FBR-Design Studio.',
  ...
  'settings.mcpServerHint': 'Expón FBR-Design Studio como servidor MCP para tu agente de código.',
  ...
  'preview.errorBody': 'No se pudo obtener el HTML del ejemplo. Asegúrate de que FBR-Design Studio esté en ejecución e inténtalo de nuevo.',
  ...
  'pet.tabBuiltInHint': 'Compañeros incluidos con FBR-Design Studio — elige uno y adóptalo.',
  ...
  'pet.codexBundledTitle': 'Viene con FBR-Design Studio — sin descarga.',
