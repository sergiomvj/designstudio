...
export const uk: Dict = {
  ...
  'settings.welcomeTitle': 'Налаштування FBR-Design Studio',
  ...
  'settings.agentInstall.pathHint':
    'Якщо ви встановили CLI через npm або Homebrew, але вона все ще відображається як не встановлена, переконайтеся, що bin-каталог інструмента є у PATH, який успадковує daemon FBR-Design Studio (у macOS PATH у Terminal і GUI-застосунків може відрізнятися). Див. QUICKSTART.md (розділ "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Відкрийте Встановити або Документація для потрібного агента.',
  'settings.agentInstall.stepAuth':
    'Пройдіть автентифікацію у CLI постачальника (увійдіть або додайте API-облікові дані), потім поверніться до FBR-Design Studio.',
  ...
  'settings.mcpServerHint': 'Відкрийте FBR-Design Studio як MCP-сервер для вашого кодинг-агента.',
  ...
  'preview.errorBody': 'Не вдалося отримати HTML прикладу. Переконайтеся, що FBR-Design Studio запущено, і повторіть спробу.',
  ...
  'pet.tabBuiltInHint': 'Кураторські супутники в комплекті з FBR-Design Studio — виберіть один та встановіть.',
  ...
  'pet.codexBundledTitle': 'Поставляється з FBR-Design Studio — завантаження не потрібне.',
