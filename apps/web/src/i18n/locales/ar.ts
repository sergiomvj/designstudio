...
export const ar: Dict = {
  ...
  'settings.welcomeTitle': 'إعداد FBR-Design Studio',
  ...
  'settings.agentInstall.pathHint':
    'إذا ثبّتّ CLI باستخدام npm أو Homebrew وما زال يظهر كغير مثبت، فتأكد من أن مجلد bin للأداة موجود في PATH الذي يرثه daemon الخاص بـ FBR-Design Studio (قد يختلف PATH بين Terminal وتطبيقات GUI على macOS). راجع QUICKSTART.md (قسم "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'افتح رابط التثبيت أو الوثائق للوكيل الذي تفضله.',
  'settings.agentInstall.stepAuth':
    'أكمِل المصادقة في CLI الخاص بالمزوّد (تسجيل الدخول أو إضافة بيانات اعتماد API) قبل العودة إلى FBR-Design Studio.',
  ...
  'settings.mcpServerHint': 'كشف FBR-Design Studio كخادم MCP لوكيل البرمجة الخاص بك.',
  ...
  'preview.errorBody': 'فشل جلب HTML الخاص بالمثال. تأكد من تشغيل FBR-Design Studio ثم أعد المحاولة.',
  ...
  'pet.tabBuiltIn': 'مدمج',
  'pet.tabBuiltInHint': 'رفقاء منتقون مدمجون مع FBR-Design Studio - اختر واحداً وتبنَّه.',
  ...
  'pet.codexBundledTitle': 'يأتي مع FBR-Design Studio - لا حاجة للتحميل.',
