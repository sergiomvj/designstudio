...
export const id: Dict = {
  ...
  'settings.welcomeTitle': 'Siapkan FBR-Design Studio',
  ...
  'settings.agentInstall.pathHint':
    'Jika Anda memasang CLI dengan npm atau Homebrew tetapi masih tampil sebagai belum terpasang, pastikan direktori bin alat ada di PATH yang diwarisi daemon FBR-Design Studio (PATH Terminal dan aplikasi GUI bisa berbeda di macOS). Lihat QUICKSTART.md (bagian "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Buka Instal atau Dokumentasi untuk agen pilihan Anda.',
  'settings.agentInstall.stepAuth':
    'Lakukan autentikasi di CLI vendor (masuk atau tambahkan kredensial API) sebelum kembali ke FBR-Design Studio.',
  ...
  'settings.mcpServerHint': 'Ekspos FBR-Design Studio sebagai server MCP untuk agen koding Anda.',
  ...
  'preview.errorBody': 'Pengambilan HTML contoh gagal. Pastikan FBR-Design Studio berjalan, lalu coba lagi.',
  ...
  'pet.tabBuiltInHint': 'Pet pilihan yang disertakan dengan FBR-Design Studio - pilih satu lalu adopsi.',
  ...
  'pet.codexBundledTitle': 'Disertakan dengan FBR-Design Studio - tidak perlu diunduh.',
