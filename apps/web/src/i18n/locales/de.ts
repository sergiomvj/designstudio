...
export const de: Dict = {
  ...
  'settings.welcomeTitle': 'FBR-Design Studio einrichten',
  ...
  'settings.agentInstall.pathHint':
    'Wenn Sie eine CLI mit npm oder Homebrew installiert haben und sie weiterhin als nicht installiert angezeigt wird, stellen Sie sicher, dass das Bin-Verzeichnis der CLI im PATH enthalten ist, den der FBR-DesignStudio-Daemon erbt (Terminal und GUI-Apps koennen sich unter macOS unterscheiden). Siehe QUICKSTART.md (Abschnitt "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Oeffnen Sie Installieren oder Doku fuer den gewuenschten Agenten.',
  'settings.agentInstall.stepAuth':
    'Authentifizieren Sie sich mit der Anbieter-CLI (anmelden oder API-Zugangsdaten setzen), bevor Sie zu FBR-Design Studio zurueckkehren.',
  ...
  'settings.mcpServerHint': 'Stelle FBR-Design Studio als MCP-Server für deinen Coding-Agent bereit.',
  ...
  'preview.errorBody': 'Das Beispiel-HTML konnte nicht abgerufen werden. Stelle sicher, dass FBR-Design Studio läuft, und versuche es erneut.',
  ...
  'pet.tabBuiltInHint': 'Mit FBR-Design Studio gebündelte Begleiter — auswählen und adoptieren.',
  ...
  'pet.codexBundledTitle': 'Wird mit FBR-Design Studio ausgeliefert — kein Download nötig.',
