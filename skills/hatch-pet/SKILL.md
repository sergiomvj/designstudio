...
> **FBR-Design Studio integration.** This is the unmodified Codex `hatch-pet` skill,
> vendored under `skills/hatch-pet/` so any FBR-Design Studio agent can run it. After
