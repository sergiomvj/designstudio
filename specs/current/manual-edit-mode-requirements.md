# FBR-Design Studio Manual Edit Mode Requirements

## Purpose

This document records the accepted manual edit-mode model from `apps/edit-mode-demo` so it can be migrated into the main FBR-Design Studio web app.
...
- Preserve FBR-Design Studio's existing preview model.
...
- FBR-Design Studio-specific mode rail:
  - Preview
  - Edit
  - Comment AI
  - Tweaks
...
Existing FBR-Design Studio integration points:
